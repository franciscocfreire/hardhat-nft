...
contract DynamicSvgNft is ERC721 {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory){
        ...
        Base64.encode(bytes(abi.encodePacked('{"name":"', name(), '", "description": "An NFT that changes bsed on the Chainlink Feed", ',
        '"attribtes": [{"trait_type": "coolness", "value": 100}], "image":"',
        imageURI,
        '"}'
        )))));
    }
